...
export const BookDetails: React.FC = () => {
  ...
  if (loadingBooks) {
    return (
      <Paper sx={{ padding: 3, margin: 'auto', maxWidth: 400, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <CircularProgress />
        <Typography variant="body1" sx={{ ml: 2 }}>Ładowanie książki...</Typography>
      </Paper>
    );
  }
