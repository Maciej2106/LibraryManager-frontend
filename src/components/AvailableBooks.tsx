...
export const AvailableBooks = () => {
    ...
    const [borrowedBookTitle, setBorrowedBookTitle] = useState(''); // Tytuł wypożyczonej książki

    const handleBorrow = async (bookId: string, bookTitle: string) => {
        try {
            await borrowBook(bookId);
            setBorrowedBookTitle(bookTitle); // Ustaw tytuł wypożyczonej książki
