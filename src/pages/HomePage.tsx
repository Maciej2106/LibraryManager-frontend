  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Fade in={true} timeout={1000}>
        <Paper elevation={3} sx={{ p: 4, mb: 4, bgcolor: 'background.paper' }}>
          ...
          <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'text.secondary' }}>
            Jesteśmy biblioteką, która oferuje szeroki wybór książek z różnych gatunków. Naszym celem jest promowanie
            czytelnictwa i umożliwienie łatwego dostępu do literatury. W naszej ofercie znajdziesz zarówno klasyki, jak i
      ...
      <Slide in={true} direction="up" timeout={1000}>
        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap={4} sx={{ mb: 4 }}>
          <Box flex={1}>
          ...
          <Box flex={1}>
            <Paper elevation={3} sx={{ p: 4, height: '100%', bgcolor: 'background.paper' }}>
              ...
              <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'text.secondary', mb: 2 }}>
                Aby wypożyczyć książkę, wystarczy się zarejestrować i zalogować. Następnie możesz przeglądać katalog i
                dodawać wybrane tytuły do koszyka. Po złożeniu zamówienia, książka zostanie przygotowana do odbioru w
                wybranej przez Ciebie placówce.
              </Typography>
            </Paper>
          </Box>
        </Box>
      ...
      <Fade in={true} timeout={1000}>
        <Paper elevation={3} sx={{ p: 4, bgcolor: 'background.paper' }}>
          ...
          <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'text.secondary' }}>
            Dołącz do naszej społeczności czytelników i odkryj świat literatury!
          </Typography>
        </Paper>
      </Fade>
    </Container>
